...
import { htmlDOM, unsafeHTML } from '../../src/utils/utils.js';
...
test('Component: getComponentBySid finds nested children recursively', t => {
    ...
    parent.setLayout(() => htmlDOM`<div data-slot="main"></div>`);
    parent.addToSlot('main', child);

    child.setLayout(() => htmlDOM`<div data-slot="sub"></div>`);
...
test('Component: removeOnUnmount cleans up manual DOM elements', t => {
    ...
    comp.setLayout(() => htmlDOM`<div class="root"></div>`);
...
test('Component: queryLocal respects component scope boundaries', t => {
    ...
    child.setLayout(() => htmlDOM`<section><span>Child Span</span></section>`);
...
test('Component: mount logic with different modes', t => {
    ...
    const comp = new Component();
    comp.setLayout(() => htmlDOM`<div class="root">New</div>`);
    ...
    comp2.setLayout(() => htmlDOM`<div class="root-2">Replaced</div>`);
...
test('Component: collapse and expand state tracking', t => {
    ...
    const comp = new Component();
    comp.setLayout(() => htmlDOM`<div class="content">Visible</div>`);
...
test('Component: hydration and teleport synchronization', t => {
    ...
    class HydratedComp extends Component {
        constructor(opts) {
            super(opts);
            this.layout = () => htmlDOM`<div>Main</div>`;
            this.teleports = {
                modal: {
                    layout: () => htmlDOM`<div class="modal">New Modal</div>`,
                    target: '#portal',
                },
            };
        }
...
test('Component: recursive SID updates when adding to slots', t => {
    ...
    parent.setLayout(() => htmlDOM`<div data-slot="s1"></div>`);
    child.setLayout(() => htmlDOM`<div data-slot="s2"></div>`);
...
test('Component: full hydration cycle with teleports', t => {
    ...
    class MyApp extends Component {
        constructor(opts) {
            ...
            this.teleports = {
                msg: {
                    layout: () => htmlDOM`<div>Message</div>`,
...
test('Component: immediate mount when adding to connected parent', t => {
    ...
    const child = new Component();
    child.setLayout(() => htmlDOM`<span class="child-node">Child</span>`);
...
test('Component: deep recursive SID update', t => {
    ...
    p.setLayout(() => htmlDOM`<div data-slot="s1"></div>`);
    c.setLayout(() => htmlDOM`<div data-slot="s2"></div>`);
...
test('Component: unmount cleans up everything', t => {
    ...
    comp.setLayout(() => htmlDOM`<div class="main-shell"></div>`);

    comp.teleports = {
        popup: {
            layout: () => htmlDOM`<div id="pop">Teleport Content</div>`,
            target: document.body,
        },
    };
...
test('Component: mount supports prepend mode', t => {
    ...
    const comp = new Component();
    comp.setLayout(() => htmlDOM`<div id="new">New</div>`);
...
test('Component: immediate mount in active parent', t => {
    ...
    const child = new Component();
    child.setLayout(() => htmlDOM`<span class="child">Child</span>`);
...
test('Component: deep recursive SID update on move', t => {
    ...
    root.setLayout(() => htmlDOM`<div data-slot="slotA"></div>`);
    branch.setLayout(() => htmlDOM`<div data-slot="slotB"></div>`);
    leaf.setLayout(() => htmlDOM`<span>Leaf</span>`);
    ...
    root.setLayout(() => htmlDOM`<div data-slot="newSlot"></div>`);
...
test('Component: cleans up teleports and manual elements', t => {
    ...
    comp.teleports = {
        overlay: { layout: () => htmlDOM`<div id="tel-node"></div>`, target: document.body },
    };
