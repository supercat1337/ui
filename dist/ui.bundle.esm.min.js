function F(n,e=window.document){e.readyState==="interactive"||e.readyState==="complete"?n():e.addEventListener("DOMContentLoaded",n)}function C(n){return n.replace(/[&<"']/g,function(e){return{"&":"&amp;","<":"&lt;",'"':"&quot;","'":"&#39;"}[e]})}function B(n,e){n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> '+C(e)}function I(n,e){n.disabled=!1,n.innerText=e}function j(n,e){n.disabled=!1,n.innerHTML=e}function H(n){n.scrollTop=0}function U(n){n.scrollTop=n.scrollHeight}function q(...n){for(let e=0;e<n.length;e++)n[e].classList.add("d-none")}function N(...n){for(let e=0;e<n.length;e++)n[e].classList.remove("d-none")}function G(n,e=null,t=window.document){if(n.getElementsByClassName("spinner-border")[0])return;let r=t.createElement("span");e?r.className=e:r.className="spinner-border spinner-border-sm",n.prepend(r)}function V(n){let e=n.querySelector(".spinner-border");e&&e.remove()}function X(n=window){return!!(n.matchMedia&&n.matchMedia("(prefers-color-scheme: dark)").matches)}function K(){let n=navigator.language.match(/^[a-z]+/);return n?n[0]:"en"}function W(n,e=2,t,r){t=t||"en",r=r||{en:["bytes","KB","MB","GB","TB","PB","EB","ZB","YB"]};let s=r[t]?r[t]:r.en;if(n===0)return"0 "+s[0];let o=n<0?"-":"";n=Math.abs(n);let i=1024,l=e<0?0:e,f=Math.floor(Math.log(n)/Math.log(i));return o+parseFloat((n/Math.pow(i,f)).toFixed(l))+" "+s[f]}function Y(n){return navigator.clipboard.writeText(n)}function Z(n,e=400,t=window){n.style.opacity="0",n.style.display="block";let r=+new Date,s=()=>{let o=+new Date;n.style.opacity=String(+n.style.opacity+(o-r)/e),r=+new Date,+n.style.opacity<1&&(t.requestAnimationFrame&&t.requestAnimationFrame(s)||setTimeout(s,16))};s()}function J(n,e=400,t=window){n.style.opacity="1";let r=+new Date,s=()=>{let o=+new Date;n.style.opacity=String(+n.style.opacity-(o-r)/e),r=+new Date,+n.style.opacity>0&&(t.requestAnimationFrame&&t.requestAnimationFrame(s)||setTimeout(s,16))};s()}function Q(n){return new Promise(e=>setTimeout(e,n))}function z(n,e){return new Promise((t,r)=>{let s=Date.now(),o=!1,i=!1,l,f,h=setTimeout(()=>{i=!0,o&&(f?r(f):t(l))},e);n.then(a=>{l=a,o=!0,Date.now()-s>=e&&i&&t(a)}).catch(a=>{f=a,o=!0,Date.now()-s>=e&&i&&r(a)})})}function ee(n,e,t,r){e.addEventListener(n,function(s){let o;s.target&&s.target instanceof Element&&(o=s.target,s.target.matches(t)?r(s,o):s.target.closest(t)&&(o=s.target.closest(t),r(s,o)))})}function y(n,...e){let t=[],r=Array.isArray(n)?n:[n];for(let o=0;o<e.length;o++)t.push(r[o]+C((e[o]||"").toString()));t.push(r[r.length-1]);let s=document.createElement("template");return s.innerHTML=t.join(""),s.content}function ne(n){var e=new Date(n*1e3);return`${e.toLocaleDateString("en-GB")} ${e.toLocaleTimeString("en-GB")}`}function re(n){var e=new Date(n*1e3);return`${e.toLocaleDateString("en-GB")}`}function se(n=new Date){return Math.floor(n.getTime()/1e3)}function A(n,e,t=2,r="..."){if(e<=1)return["1"];let s=[n];for(let c=1;c<=t;c++)s.unshift(n-c),s.push(n+c);let o=s.filter(c=>c>1&&c<e).map(c=>c.toString()),i=n>3+t,l=n===3+t,f=n<e-(2+t),h=n===e-(2+t);l&&o.unshift("2"),h&&o.push((e-1).toString()),i&&o.unshift(r),f&&o.push(r);let a=e.toString();return["1",...o,a]}function ie(n,e,t,r){let s=document.createElement("ul");return s.classList.add("pagination"),A(n,e).forEach(i=>{let l=document.createElement("li");if(l.classList.add("page-item"),i=="..."){l.classList.add("disabled");let h=document.createElement("span");h.classList.add("page-link"),h.textContent=i,l.appendChild(h),s.appendChild(l);return}let f=document.createElement("a");f.classList.add("page-link"),i==n.toString()&&l.classList.add("active"),t?f.href=t(Number(i)):f.href="#",f.textContent=i,f.setAttribute("data-page-value",i),l.appendChild(f),s.appendChild(l),r&&f.addEventListener("click",h=>{h.preventDefault();let a=h.target;if(!a)return!1;let c=a.getAttribute("data-page-value");return c?r(Number(c)):!1})}),s}var _=class{items=new Map;#e="";addItem(e,t,r){if(this.items.has(e))throw new Error("Item already exists");this.items.set(e,{isActive:!1,on:t,off:r})}removeItem(e){this.#e===e&&(this.#e=""),this.items.delete(e)}setActive(e){if(!this.items.has(e))throw new Error("Item not found");if(this.#e!==e)for(let[t,r]of this.items)t===e?(this.#e=t,r.isActive||(r.isActive=!0,r.on(t))):(r.isActive&&r.off(t),r.isActive=!1)}runCallbacks(){for(let[e,t]of this.items)t.isActive?t.on(e):t.off(e)}init(e){this.setActive(e),this.runCallbacks()}};function M(n=window.document){if(!n)throw new Error("Document is null. Cannot inject core styles.");let e=`
.d-none {
