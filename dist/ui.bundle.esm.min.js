...
`}var mt=class extends d{tableView;pagination;root_element;refsAnnotation={title:HTMLSpanElement.prototype,add_data_button:HTMLButtonElement.prototype,update_data_button:HTMLButtonElement.prototype,table:HTMLTableElement.prototype,pagination_section:HTMLElement.prototype};refs;eventsDeclaration=["connect","refsConnected","renderLayout"];#t="";constructor(){super(),this.tableView=new H,this.pagination=new S,this.setLayout(te),this.on("refsConnected",()=>{this.refs.title.innerText=this.#t}),this.on("renderLayout",()=>{this.tableView.renderLayout(this.refs.table),this.pagination.renderLayout(this.refs.pagination_section)})}on(t,e){return super.on(t,e)}get status(){return this.tableView.status}setStatus(t,e){this.isConnected()&&this.tableView.setStatus(t,e)}set title(t){this.#t=t,this.isConnected()&&(this.refs.title.innerText=this.#t)}get title(){return this.#t}render(t){this.tableView.render(t),this.pagination.render(t)}};export{d as Component,jn as DOMReady,O as ItemList,pt as PaginatedItemList,mt as PaginatedTable,S as Pagination,H as TableView,v as Widget,N as escapeHtml,zn as hideElements,Gn as hideModal,Qn as removeSpinnerFromButton,Yn as scrollToBottom,Wn as scrollToTop,qn as showElements,Jn as showModal,Un as showSpinnerInButton,Bn as ui_button_status_waiting_off,Kn as ui_button_status_waiting_off_html,Fn as ui_button_status_waiting_on};
